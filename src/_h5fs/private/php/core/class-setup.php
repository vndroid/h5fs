...
class Setup {
    ...
    private function add_app_metadata(): void {
        $this->set('NAME', 'h5fs');
        $this->set('VERSION', H5FS_VERSION);
        $this->set('FILE_PREFIX', '_h5fs');
    }
    ...
    private function add_paths(): void {
        ...
        $this->set('H5FS_HREF', Util::normalize_path(dirname($script_name, 2), true));
        $this->set('H5FS_PATH', Util::normalize_path(dirname(__DIR__, 3), false));

        $this->set('ROOT_HREF', Util::normalize_path(dirname($this->get('H5FS_HREF')), true));
        $this->set('ROOT_PATH', Util::normalize_path(dirname($this->get('H5FS_PATH')), false));

        $this->set('PUBLIC_HREF', Util::normalize_path($this->get('H5FS_HREF') . '/public/', true));
        $this->set('PUBLIC_PATH', Util::normalize_path($this->get('H5FS_PATH') . '/public/', false));
        ...
        $this->set('PRIVATE_PATH', Util::normalize_path($this->get('H5FS_PATH') . '/private', false));
